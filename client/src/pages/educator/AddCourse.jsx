 ...
 const handleSubmit = async (e)=>{
  try{
    ...
    const { data } = await axios.post(backendUrl + 
      '/api/educator/add-course', formData,
    ...
    <div className="h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <form onSubmit={handleSubmit } className="flex flex-col gap-4 w-full max-w-md text-gray-500">
        ...
        <div>
              ...
              {!chapter.collapsed && (
                <div className="p-4">
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div
                      key={lectureIndex}
                      className="flex justify-between items-ceenter mb-2"
                    >
                      <span>
          ...
          <div
            className="flex justify-center items-center bg-red-100 p-2 rounded-lg cursor-pointer"
            ...
            <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <button onClick={()=>addLecture()}
                  type="button"
                  className="w-full bg-red-800 text-white rounded py-2 px-4"
                >
                  Add
                </button>
